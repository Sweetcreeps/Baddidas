        ...
        <div className="container-fluid">
            ...
            <div className="row " >
                <div className="col-md-12 text image-with-text">
                    ...
                    <img className="home-img" src="./Images/Mainimg.jpg" fluid />
